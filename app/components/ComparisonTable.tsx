...
const features: FeatureRow[] = [
  ...
  {
    feature: 'Remote repo auto-setup (GitHub/GitLab/custom)',
    tuck: 'yes',
    chezmoi: 'no',
    dotbot: 'no',
    rcm: 'no',
  ...
  {
    feature: 'Drift detection (verify)',
    tuck: 'yes',
    chezmoi: 'partial',
    dotbot: 'no',
    rcm: 'no',
  ...
  {
    feature: 'Track files in any repo',
    tuck: 'yes',
    chezmoi: 'no',
    dotbot: 'no',
    rcm: 'no',
